...
var UpdateParameters = require('common/UpdateParameters');
var updateUrl = 'https://www.seoquake.com/parameters/latest.json';
...
new UpdateParameters(browser, updateUrl, configuration, parameters);
...
var messagesDispatcher = {
  ...
  'sq.getSeoquakeCookies': function sqGetSeoquakeCookies(empty, callback, sender) {
    browser.getCookiesFromHost('www.seoquake.com').then(function (cookies) {
...
if (!false) {
  isNewInstall.then(function (isNewInstall) {
    if (isNewInstall) {
      browser.getCookiesFromHost('www.seoquake.com').then(function (cookies) {
        var onboarding = cookies.find(function (cookie) {
          return typeof cookie.name !== 'undefined' && cookie.name === 'onboarding';
        });
        if (!onboarding) {
          browser.openTab('https://www.seoquake.com/welcome/index.html');
        }
      }).catch(ignore);
    }
  });
...
},{"browser/Browser":2,"common/Configuration":7,"common/Lib":8,"common/Modules":10,"common/Parameters":11,"common/UpdateParameters":12,"common/analytics/Analytics":13,"common/lib/ignore":25,"common/oauth/OAuthQueue":39,"common/parameters/Parameters":40,"common/parameters/ParametersCache":41,"common/semrush/SemrushClient":43,"common/storage/simpleStorage":46,"common/utils/Counter.js":47,"common/utils/RequestQueue":49,"extend":55}],2:[function(require,module,exports){
'use strict';
...
function _loadGSCScripts(tab) {
  ...
  if (gscMatches.some(function (regexp) {
    return regexp.test(tab.url);
  }) && !gscExcludeMatches.some(function (regexp) {
    return regexp.test(tab.url);
  })) {
    return new Promise(function (resolve) {
      chrome.tabs.executeScript(tab.getIdentifier(), scriptConfig, function () {
        chrome.tabs.insertCSS(tab.getIdentifier(), cssConfig, resolve);
      });
    });
  } else {
    return Promise.reject('No match');
    ...
    value: function registerContentScripts(messagesDispatcher) {
      ...
      chrome.tabs.query({}, function (tabs) {
        tabs.forEach(function (tab) {
          ...
          _loadGSCScripts(new Tab(_this5, tab)).catch(nop);
        });
      });
...
},{"../common/Lib":8,"../common/browserBase/Browser":15,"../common/browserBase/Tab":16,"../common/defaults/configuration":17,"../common/defaults/parameters":18,"../common/lib/ignore":25,"./ContextMenu":3,"./MainPanel":5,"extend":55}],3:[function(require,module,exports){
'use strict';
...
},{"../common/browserBase/Tab":16}],7:[function(require,module,exports){
'use strict';
...
},{"./Lib":8,"./utils/eventsMixin":50,"extend":55}],8:[function(require,module,exports){
'use strict';
...
},{"./googleChecksum":19,"./hex-md5":20,"./lib/arrayFrom":21,"./lib/containsText.js":22,"./lib/endsWith.js":23,"./lib/getUUID":24,"./lib/ip2long":26,"./lib/isArray":27,"./lib/isEmpty":28,"./lib/isObject":30,"./lib/isString":32,"./lib/parseArgs":33,"./lib/parseUri":34,"./lib/shortHash":35,"./lib/startsWith.js":36,"./lib/trimHash":37}],9:[function(require,module,exports){
'use strict';
...
},{"./hex-md5":20}],10:[function(require,module,exports){
'use strict';
...
},{"browser/Browser":2,"modules/SQCommon":51,"modules/SQLinkinfo":52,"modules/SQPanel":53,"modules/SQSERPTool":54}],11:[function(require,module,exports){
'use strict';
...
},{"./Configuration":7,"./Lib":8,"./lib/isParameterDeleted":31,"extend":55}],12:[function(require,module,exports){
'use strict';

var lib = require('./Lib');

function UpdateParameters(browser, updateUrl, configuration, parameters) {
  this.browser = browser;
  this.updateUrl = updateUrl;
  this.configuration = configuration;
  this.parameters = parameters;

  this.doUpdateListener = this.doUpdate.bind(this);

  parameters.onReady(function () {
    configuration.onReady(this.doUpdateListener);
  }.bind(this));
}

UpdateParameters.prototype.readyProcess = function (xhr) {
  if (xhr.readyState === 4) {
    if (xhr.status === 200) {
      this.configuration.set('core.last_parameters_update', xhr.getResponseHeader('Last-Modified'));
      this.configuration.save();
      try {
        var newParameters = JSON.parse(xhr.responseText);
        if (lib.isObject(newParameters)) {
          this.parameters.updateDefault(newParameters);
        }

        this.browser.setTimeout(this.doUpdateListener, 86400000);
      } catch (e) {
        this.parameters.restorePackageParameters();
      }
    } else {
      this.parameters.restorePackageParameters();
    }
...
UpdateParameters.prototype.doUpdate = function () {
  var _this = this;

  var lastUpdate = this.configuration.get('core.last_parameters_update', null);
  var xhr = this.browser.createXHR();
...
var Analytics = function () {
  ...
  _createClass(Analytics, [{
    ...
    value: function sendRequest(data) {
      ...
      request += '&cs=' + encodeURIComponent('3.6.7') + '&cm=chrome&ds=' + encodeURIComponent('3.6.7');
...
},{"../lib/getUUID":24,"../lib/isEmpty":28,"../lib/isFunction":29,"../lib/isString":32,"browser/Browser":2,"extend":55}],14:[function(require,module,exports){
'use strict';
...
},{"../lib/isEmpty":28}],15:[function(require,module,exports){
'use strict';

var analyticsBrowserMixin = require('../analytics/browserMixin');
var isFunction = require('../lib/isFunction');
var Tab = require('browser/Tab');
var CookieManager = require('browser/CookieManager');
...
Browser.prototype.getCookiesFromHost = CookieManager.getCookiesFromHost;
...
},{"../analytics/browserMixin":14,"../lib/isFunction":29,"../lib/versionCompare":38,"browser/CookieManager":4,"browser/Tab":6}],16:[function(require,module,exports){
'use strict';
...
},{"./isArray":27}],23:[function(require,module,exports){
'use strict';
...
},{"./isEmpty":28}],35:[function(require,module,exports){
'use strict';
...
},{"../hex-md5":20}],36:[function(require,module,exports){
'use strict';
...
},{"./isEmpty":28}],39:[function(require,module,exports){
'use strict';
...
},{"../lib/getUUID":24}],40:[function(require,module,exports){
'use strict';
...
},{"../lib/ignore":25}],41:[function(require,module,exports){
'use strict';
...
},{"../Lib":8,"../utils/RequestObject":48,"extend":55}],42:[function(require,module,exports){
'use strict';
...
var SemrushClient = function () {
  ...
  _createClass(SemrushClient, [{
    ...
    value: function requestTrafficAnalytics(callback, q) {
      var _this14 = this;
      ...
      this._queue.push({
        url: function url() {
          return SemrushClient.URL_TRAFFIC_ANALYTICS + '?domain=' + encodeURIComponent(q) + '&access_token=' + _this14._token;
        },
        type: 'get',
        resolve: function resolve(answer) {
          _this14._trafficAnalyticsCache.set(q, answer);
          _resolve3(answer);
        },
    ...
    value: function process(request, callback) {
      ...
      switch (request.action) {
        ...
        case 'getTrafficAnalytics':
          ...
          this.requestTrafficAnalytics(callback, request.q);
...
SemrushClient.URL_TRAFFIC_ANALYTICS = SemrushClient.API_SERVER_URL + '/api/v1/ta';
...
},{"../lib/isArray":27,"../lib/isEmpty":28,"../lib/isObject":30,"../lib/parseArgs":33,"./SemrushBacklinksCache":42,"./SemrushNotesCache":44,"./SemrushRequestQueue":45,"extend":55}],44:[function(require,module,exports){
'use strict';
...
},{"../lib/isString":32,"extend":55}],45:[function(require,module,exports){
'use strict';
...
},{"../lib/isFunction":29,"extend":55}],46:[function(require,module,exports){
'use strict';
...
},{"browser/Browser":2}],50:[function(require,module,exports){
'use strict';
...
},{"../lib/isFunction":29,"../lib/isString":32}],51:[function(require,module,exports){
'use strict';
...
},{"browser/Browser":2,"browser/Tab":6,"common/Module":9}],52:[function(require,module,exports){
'use strict';
...
},{"browser/Browser":2,"common/Lib":8,"common/Module":9}],53:[function(require,module,exports){
'use strict';
...
},{"browser/Browser":2,"common/Module":9}],55:[function(require,module,exports){
'use strict';
