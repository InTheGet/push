...
var LinkComparePlugin = require('modules/linkinfo/src/LinkComparePlugin');
var updateContainerHeight = require('common/effects/updateContainerHeight');
var client = require('browser/Client');

function init() {
  var plugin = new LinkComparePlugin(document.body);
...
},{"browser/Client":2,"common/effects/updateContainerHeight":41,"modules/linkinfo/src/LinkComparePlugin":79}],2:[function(require,module,exports){
'use strict';
...
},{"../common/Lib":7,"../common/analytics/clientMixin":10,"../common/utils/entities":70,"./ClientMessages":3,"./DeathQueue":4,"./clientTranslate":5,"extend":86}],3:[function(require,module,exports){
'use strict';
...
},{"../common/lib/isFunction":52}],4:[function(require,module,exports){
'use strict';
...
},{"../common/utils/entities":70}],6:[function(require,module,exports){
'use strict';
...
},{"./Lib":7,"./basePlugin/ErrorDisable":11,"./basePlugin/uiMixin":12,"./dom/main":27,"./lib/ignore":48,"./utils/eventsMixin":71,"./utils/messengerModuleMixin":74,"./utils/normalizeNumber":76,"extend":86,"html-entities":87}],7:[function(require,module,exports){
'use strict';
...
},{"./googleChecksum":42,"./hex-md5":43,"./lib/arrayFrom":44,"./lib/containsText.js":45,"./lib/endsWith.js":46,"./lib/getUUID":47,"./lib/ip2long":49,"./lib/isArray":50,"./lib/isEmpty":51,"./lib/isObject":53,"./lib/isString":54,"./lib/parseArgs":55,"./lib/parseUri":56,"./lib/shortHash":57,"./lib/startsWith.js":58,"./lib/trimHash":59}],8:[function(require,module,exports){
'use strict';
...
},{"./BasePlugin":6,"./Lib":7,"./dom/main":27,"./serpPlugin/ParametersCounter":66,"./utils/Date":68,"./utils/messengerTranslateMixin":75}],9:[function(require,module,exports){
'use strict';
...
},{"./Lib":7,"./utils/RenderObject":69}],10:[function(require,module,exports){
'use strict';
...
},{"../lib/isEmpty":51}],11:[function(require,module,exports){
'use strict';
...
},{"../Lib":7,"../dom/main":27}],13:[function(require,module,exports){
'use strict';
...
},{"../lib/isEmpty":51,"./main.js":27}],15:[function(require,module,exports){
'use strict';
...
},{"./_createElement":15,"dom-element-css":81}],20:[function(require,module,exports){
'use strict';
...
},{"to-camel-case":92}],24:[function(require,module,exports){
'use strict';
...
},{"../lib/isEmpty":51}],27:[function(require,module,exports){
'use strict';
...
},{"../lib/ignore":48,"./Chain":13,"./appendText":16,"./clearValue":17,"./correctZIndex":18,"./createElement":19,"./emptyElement":20,"./getElementText":21,"./getOffset":22,"./hasAttribute":23,"./hasClass":24,"./isBodyReady":25,"./isChild":26,"./parseMarkdown":28,"./pixelValue":29,"./qualifyURL":30,"./removeElement":31,"./setContent":32,"./setText":33,"dom-element":84}],28:[function(require,module,exports){
'use strict';
...
},{"extend":86}],29:[function(require,module,exports){
'use strict';
...
},{"../lib/isEmpty":51}],32:[function(require,module,exports){
'use strict';
...
},{"./_createElement":15,"./emptyElement":20}],33:[function(require,module,exports){
'use strict';
...
},{"../dom/main":27}],35:[function(require,module,exports){
'use strict';
...
},{"../utils/eventsMixin":71,"extend":86}],36:[function(require,module,exports){
'use strict';
...
},{"../dom/main":27,"../utils/eventsMixin":71,"extend":86}],37:[function(require,module,exports){
'use strict';
...
},{"../dom/main":27,"./Overlay.js":38,"./ScrollBlock":39,"extend":86}],38:[function(require,module,exports){
'use strict';
...
},{"../dom/main":27,"./FloatPanel":36,"extend":86}],39:[function(require,module,exports){
'use strict';
...
},{"../dom/main":27,"../lib/ignore":48,"./Draggable":35,"extend":86}],40:[function(require,module,exports){
'use strict';
...
},{"../dom/main":27}],42:[function(require,module,exports){
'use strict';
...
},{"./isArray":50}],46:[function(require,module,exports){
'use strict';
...
},{"./isEmpty":51}],57:[function(require,module,exports){
'use strict';
...
},{"../hex-md5":43}],58:[function(require,module,exports){
'use strict';
...
},{"../Lib":7,"../LinksListPlugin":8,"../RequestUrl.js":9,"../dom/main":27,"../effects/Overlay":38,"../lib/ignore":48,"../parameters/ConfigureWindow":62,"../utils/CreateFilename":67,"../utils/messengerTranslateMixin":75,"./moduleMixin":61}],61:[function(require,module,exports){
'use strict';
...
},{"../basePlugin/ErrorDisable":11,"../dom/main":27,"../effects/MessageWindow":37,"../effects/Overlay":38}],62:[function(require,module,exports){
'use strict';
...
},{"../dom/main":27,"../effects/MessageWindow":37,"../lib/ignore":48,"../utils/eventsMixin":71,"../utils/translateMixin":78,"./ParametersCheckboxes":64,"extend":86}],63:[function(require,module,exports){
'use strict';
...
},{"../dom/main":27,"../utils/eventsMixin":71}],64:[function(require,module,exports){
'use strict';
...
},{"../dom/main":27,"../effects/ColumnDisplay":34,"../effects/noramlizeColumnsMixin":40,"../lib/ignore":48,"../utils/translateMixin":78,"./ParameterItemCheckbox":63,"./ParametersList":65}],65:[function(require,module,exports){
'use strict';
...
},{"../utils/eventsMixin":71}],66:[function(require,module,exports){
'use strict';
...
},{"../utils/eventsMixin":71}],67:[function(require,module,exports){
'use strict';
...
},{"sanitize-filename":91}],68:[function(require,module,exports){
'use strict';
...
},{"../lib/shortHash":57}],70:[function(require,module,exports){
'use strict';
...
},{"html-entities":87}],71:[function(require,module,exports){
'use strict';
...
},{"../lib/isFunction":52,"../lib/isString":54}],72:[function(require,module,exports){
'use strict';
...
},{"../lib/isEmpty":51}],73:[function(require,module,exports){
'use strict';
...
},{"./messengerBaseMixin":72}],74:[function(require,module,exports){
'use strict';
...
},{"../lib/getUUID":47,"./messengerMixin":73}],75:[function(require,module,exports){
'use strict';
...
},{"./messengerBaseMixin":72}],76:[function(require,module,exports){
'use strict';
...
},{"../dom/main":27,"../lib/ignore":48}],78:[function(require,module,exports){
'use strict';
...
},{"../lib/ignore":48}],79:[function(require,module,exports){
'use strict';
...
var URLsList = require('./import/URLsList');

var LinkComparePlugin = function (_LinkInfoBase) {
  _inherits(LinkComparePlugin, _LinkInfoBase);

  function LinkComparePlugin(container) {
    _classCallCheck(this, LinkComparePlugin);

    var _this = _possibleConstructorReturn(this, (LinkComparePlugin.__proto__ || Object.getPrototypeOf(LinkComparePlugin)).call(this, container));

    _this.name = 'linkinfo';
    _this.query = {};
    _this.searchQuery = 'compare';
    _this.MAX_URLS_LIMIT = 500;
    _this.links = [];
    _this.totalParameters = 0;
    _this.readyParameters = 0;
    _this.showNoFollow = false;
    ...
    _this.processDataListener = _this.processDataHandler.bind(_this);
    _this.showEditListener = _this.showEditHandler.bind(_this);
    _this.processImport = _this.handleImport.bind(_this);
  ...
  _createClass(LinkComparePlugin, [{
    key: 'findByRole',
    ...
    value: function init() {
      ...
      this.t('sqCompare_document_title').then(function (text) {
        return document.title = text;
      }).catch(ignore);
      this.T('title', 'sqCompare_title');
      this.T('howto-link', 'sqCommon_howto_link');
      this.T('suggest-link', 'sqCommon_suggest_link');
      this.T('urls-to-check-1', 'sqCompare_url_to_check_1');
      this.T('urls-to-check-2', 'sqCompare_url_to_check_2');
      this.T('button-process', 'sqCompare_button_process');
      ...
      this.T('button-edit', 'sqCompare_button_edit');
      this.T('button-import', 'sqCompare_button_import');

      var importButton = document.getElementById('import_button');
      importButton.addEventListener('click', function (event) {
        return _this2.registerEvent(_this2.name, 'Import file');
      }, true);

      this._importURLs = new URLsList(importButton, document.getElementById('import_file_name'));
      this._importURLs.autoInit();
      this._importURLs.addEventListener('data', this.processImport);
      this._importURLs.addEventListener('error', function (error) {
        alert(error.message);
      });

      _get(LinkComparePlugin.prototype.__proto__ || Object.getPrototypeOf(LinkComparePlugin.prototype), 'init', this).call(this);
    }
  }, {
    key: 'process',
    value: function process() {
      ...
      this.container.querySelector('[data-role="button-process"]').addEventListener('click', this.processDataListener, true);
      this.container.querySelector('[data-role="button-edit"]').addEventListener('click', this.showEditListener, true);
      if (this.configuration.mode === lib.SEOQUAKE_MODE_BY_REQUEST) {
        var requestButton = this.container.querySelector('[data-role="button-request"]');
      ...
      new Promise(function (resolve, reject) {
        ...
        if (url.startsWith('http://') || url.startsWith('https://')) {
          dom.value(_this3.container.querySelector('[data-role="urls"]'), url);
        }

        _this3.dispatchEvent('ready');
        _this3.showUserDataWindow();
      }).catch(function () {});
    }
  }, {
    key: 'showEditHandler',
    value: function showEditHandler(event) {
      this.preventDefaultListener(event);

      if (dom.hasClass(event.currentTarget, 'sqbtn-pressed')) {
        dom.removeClass(event.currentTarget, 'sqbtn-pressed');
        this.hideUserDataWindow();
      } else {
        dom.addClass(event.currentTarget, 'sqbtn-pressed');
        this.showUserDataWindow();
      }
    }
  }, {
    key: 'processDataHandler',
    value: function processDataHandler(event) {
      this.preventDefaultListener(event);
      dom.removeClass(this.container.querySelector('[data-role="button-edit"]'), 'sqbtn-pressed');
      this.initFromUserData();

      this.registerEvent(this.name, 'Process');
    }
  }, {
    key: 'initFromUserData',
    value: function initFromUserData() {
      var userLinks = dom.value(this.container.querySelector('[data-role="urls"]'));
      var links = [];
      ...
      if (userLinks.length > this.MAX_URLS_LIMIT) {
        userLinks.length = this.MAX_URLS_LIMIT;
      }
      ...
      try {
        for (var _iterator = userLinks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var userLink = _step.value;
    ...
    value: function clearData() {
      ...
      dom.emptyElement(this.table.tHead);
    }
  }, {
    key: 'processData',
    ...
    value: function _createLinkRowInternal(index) {
      ...
      var linkUrl = dom('A', { className: 'seoquake-params-link', href: link.href, rel: urlHash + ' x_url', target: '_blank' }, lib.truncate(link.href));
    ...
    value: function createLinkRow(index) {
      ...
      if (index < this.links.length) {
        ...
        this.processRequestUrls(this.requestUrlsMap);
      }
    }
  }, {
    key: 'sortHandler',
    ...
    value: function render(renderParams) {
      ...
      for (var i = 0, l = renderParams.params.length; i < l; i++) {
        ...
        var links = Array.from(this.container.querySelectorAll(selector));
    ...
    key: 'showUserDataWindow',
    value: function showUserDataWindow() {
      var editorBlock = this.container.querySelector('[data-role="urls-block"]');
      dom.removeClass(editorBlock, 'hidden');
      var editorInput = this.container.querySelector('[data-role="urls"]');
      editorInput.focus();
      this.overlay.hide();
    }
  }, {
    key: 'hideUserDataWindow',
    value: function hideUserDataWindow() {
      var editorBlock = this.container.querySelector('[data-role="urls-block"]');
      dom.addClass(editorBlock, 'hidden');
    }
  }, {
    key: 'getDataLines',
    value: function getDataLines() {
    ...
    key: 'handleImport',
    value: function handleImport(data) {
      dom.value(this.container.querySelector('[data-role="urls"]'), data.join('\n'));
    }
  }]);

  return LinkComparePlugin;
}(LinkInfoBase);

quickTmixin(LinkComparePlugin.prototype);
messengerModuleMixin(LinkComparePlugin.prototype);

module.exports = LinkComparePlugin;

},{"../../../common/Lib":7,"../../../common/RequestUrl":9,"../../../common/dom/CounterElement":14,"../../../common/dom/main":27,"../../../common/lib/ignore":48,"../../../common/module/LinkInfoBase":60,"../../../common/utils/messengerModuleMixin":74,"../../../common/utils/quickTmixin":77,"./import/URLsList":80,"extend":86}],80:[function(require,module,exports){
'use strict';
...
var isString = require('../../../../common/lib/isString');

var URLsList = function () {
  function URLsList(button, input) {
  ...
  _createClass(URLsList, [{
    ...
    value: function processResult(data) {
      ...
      var firstLineString = lines.shift();
      if (firstLineString === '') {
        return;
      }
      ...
      var dataColumn = 0;
      var result = [];
      var firstLineArray = firstLineString.substring(1, firstLineString.length - 1).split(/"[,;]"/i);
      if (firstLineArray.length > 0) {
        dataColumn = Math.max(0, firstLineArray.indexOf('Url'));
      }

      lines.forEach(function (line) {
        var lineArray = line.substring(1, firstLineString.length - 1).split(/"[,;]"/i);
        if (lineArray.length > 0) {
          var value = lineArray[dataColumn];
          if (value !== undefined && value !== null && (value.startsWith('http://') || value.startsWith('https://'))) {
            result.push(value);
          }
        }
      });
      ...
      if (result.length > 0) {
        ...
        this.dispatchEvent('error', new Error('No URLs found in file'));
      }
    }
  }, {
    key: 'startSelect',
      ...
      if (files.length > 0) {
        ...
        if (file.size < 1048576) {
          if (['text/csv', 'text/plain'].indexOf(file.type) !== -1) {
            ...
            this.dispatchEvent('error', new Error('File is not text file'));
          }
        } else {
          this.dispatchEvent('error', new Error('File is too big to process'));
        }
      } else {
        this.dispatchEvent('error', new Error('Please select just one file'));
      }
    }
  }]);
...
eventsMixin(URLsList.prototype);

module.exports = URLsList;

},{"../../../../common/lib/isString":54,"../../../../common/utils/eventsMixin":71}],81:[function(require,module,exports){
var toCamelCase = require('to-camel-case');
...
},{"to-camel-case":82}],82:[function(require,module,exports){
...
},{"to-space-case":96}],83:[function(require,module,exports){
/**
...
},{"dom-element-css":81,"dom-element-value":83,"to-camel-case":85}],85:[function(require,module,exports){
arguments[4][82][0].apply(exports,arguments)
},{"dup":82,"to-space-case":96}],86:[function(require,module,exports){
'use strict';
...
},{"./lib/html4-entities.js":88,"./lib/html5-entities.js":89,"./lib/xml-entities.js":90}],88:[function(require,module,exports){
...
},{"truncate-utf8-bytes":97}],92:[function(require,module,exports){
...
},{"to-space-case":94}],93:[function(require,module,exports){
...
},{"to-no-case":95}],97:[function(require,module,exports){
'use strict';
...
},{"./lib/truncate":98,"utf8-byte-length/browser":99}],98:[function(require,module,exports){
'use strict';
