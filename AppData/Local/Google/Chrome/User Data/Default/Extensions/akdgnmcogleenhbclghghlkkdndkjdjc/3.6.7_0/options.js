...
},{"../common/Lib":5,"../common/analytics/clientMixin":7,"../common/utils/entities":75,"./ClientMessages":2,"./DeathQueue":3,"./clientTranslate":4,"extend":104}],2:[function(require,module,exports){
'use strict';
...
module.exports = {
  1: {
    ...
    matches: ['<div id="resultStats">About ([0-9,]+) results<nobr>', '<div id="resultStats">([0-9,]+) results<nobr>', '<div id="resultStats">About ([0-9,]+) result<nobr>', '<div id="resultStats">([0-9,]+) result<nobr>'],
  ...
  15: {
    ...
    'url-s': 'https://www.semrush.com/analytics/backlinks/backlinks/{url|encode}:url?utm_source=seoquake&utm_medium=toolbar&utm_campaign=params&ref=174537735',
  ...
  32: {
    ...
    title: 'Age',
    icon: 'webarchive',
    'url-s': 'https://web.archive.org/web/*/{scheme}://{domain}',
    'url-r': 'https://web.archive.org/__wb/sparkline?url={scheme}://{domain}&output=json',
    matches: ['<a href="/web/\\d+/.+"*>([^<]+)</a>', '<span class="mainTitle"> Sorry, (no matches)\\. <\/span>', '(Blocked Site) Error', '"first_ts":"(\\d{4})(\\d{2})(\\d{2})\\d{6}"'],
    disabled: ['internal'],
    type: 'domain'
  },
  35: {
  ...
  36: {
    ...
    title: '+1',
    icon: 'google-plus',
    'url-r': 'https://plusone.google.com/u/0/_/+1/fastbutton?count=true&url={url}',
    matches: ['<div id="aggregateCount"[^>]+>([^<]+)<\/div>'],
    disabled: ['google', 'yahoo', 'bing', 'yandex', 'linkinfo', 'semrush', 'external'],
    type: 'page'
  },
  37: {
  ...
  50: {
    ...
    title: 'CY',
    icon: 'yandex',
    'url-r': 'https://bar-navig.yandex.ru/u?ver=2&url={url|encode}&show=1&post=0',
    matches: ['<tcy rang="(\\d*)" value="(\\d*)"'],
  ...
  53: {
    name: 'Yandex catalogue',
    title: 'YCat',
    icon: 'yandex',
    'url-r': 'https://search.yaca.yandex.ru/yandsearch?text={domain|encode}&doSearch=%CD%E0%E9%F2%E8&rpt=rs2',
    matches: ['<div class="z-counter">[\\s\\S]+(\\d+)<\/div>', '<div class="info info_before-columns">[^<+]+: (\\d+)<\\/div>', '<TITLE>[\\s\\S]+\\((\\d+)\\)[\\s\\S]+<\/TITLE>'],
    disabled: ['seobar', 'google', 'yahoo', 'bing', 'linkinfo', 'semrush', 'internal', 'external'],
    type: 'domain'
  },
  60: {
  ...
  61: {
    name: 'Linkedin share count',
    title: 'IN',
    icon: 'linkedin',
    'url-r': 'https://www.linkedin.com/countserv/count/share?url={url|encode}&format=json',
    matches: ['"count":\\s*(\\d+)'],
    disabled: ['google', 'yahoo', 'bing', 'yandex', 'linkinfo', 'semrush', 'internal', 'external'],
    type: 'page'
  },
...
},{"./_createElement":11,"dom-element-css":99}],16:[function(require,module,exports){
'use strict';
...
},{"../lib/ignore":52,"./Chain":10,"./appendText":12,"./clearValue":13,"./correctZIndex":14,"./createElement":15,"./emptyElement":16,"./getElementText":17,"./getOffset":18,"./hasAttribute":19,"./hasClass":20,"./isBodyReady":21,"./isChild":22,"./parseMarkdown":24,"./pixelValue":25,"./qualifyURL":26,"./removeElement":27,"./setContent":28,"./setText":29,"dom-element":102}],24:[function(require,module,exports){
'use strict';
...
},{"extend":104}],25:[function(require,module,exports){
'use strict';
...
},{"../utils/eventsMixin":76,"extend":104}],32:[function(require,module,exports){
'use strict';
...
},{"../dom/main":23,"../utils/eventsMixin":76,"extend":104}],33:[function(require,module,exports){
'use strict';
...
},{"../dom/main":23,"../utils/eventsMixin":76,"extend":104}],35:[function(require,module,exports){
'use strict';
...
},{"../dom/main.js":23,"./Dropdown":32,"extend":104}],37:[function(require,module,exports){
'use strict';
...
},{"../dom/main":23,"./Overlay.js":39,"./ScrollBlock":40,"extend":104}],39:[function(require,module,exports){
'use strict';
...
},{"../dom/main":23,"./FloatPanel":34,"extend":104}],40:[function(require,module,exports){
'use strict';
...
},{"../dom/main":23,"../lib/ignore":52,"./Draggable":31,"extend":104}],41:[function(require,module,exports){
'use strict';
...
},{"../dom/main":23,"../utils/eventsMixin":76,"extend":104}],42:[function(require,module,exports){
'use strict';
...
},{"../dom/main":23,"../lib/isString":59,"../utils/eventsMixin":76,"extend":104}],43:[function(require,module,exports){
'use strict';
...
},{"html-entities":105}],76:[function(require,module,exports){
'use strict';
...
var OptionsBase = function () {
  ...
  _createClass(OptionsBase, [{
    ...
    value: function translateMenu() {
      ...
      var wait = [];
      var _arr = ['general', 'serp', 'seobar', 'gsc', 'parameters', 'integration'];
...
},{"../../../common/dom/main":23,"../../../common/effects/FloatPanel":34,"../../../common/effects/MenuHighlight":37,"../../../common/effects/Overlay":39,"../../../common/effects/updateContainerHeight":44,"../../../common/lib/ignore":52,"../../../common/utils/messengerMixin":78,"../../../common/utils/messengerTranslateMixin":79,"./OptionsPanels":82,"extend":104}],82:[function(require,module,exports){
'use strict';
...
var GSC = require('./panels/GSCPanel');
...
var OptionsPanels = function () {
  ...
  _createClass(OptionsPanels, [{
    ...
    value: function init() {
      ...
      this._panels.set('gsc', this.createGSCPanel());
    ...
    key: 'createGSCPanel',
    value: function createGSCPanel() {
      var panel = new GSC(document.getElementById('gsc_block'));
      panel.setMessenger(this.getMessenger());
      panel.init();
      return panel;
    }
...
},{"../../../common/utils/eventsMixin":76,"../../../common/utils/messengerMixin":78,"../../../common/utils/messengerTranslateMixin":79,"./panels/GSCPanel":91,"./panels/General":92,"./panels/Integration":93,"./panels/Parameters":94,"./panels/Seobar":95,"./panels/Serp":96,"extend":104}],83:[function(require,module,exports){
'use strict';
...
},{"../../../common/Lib":5,"../../../common/dom/main":23,"../../../common/effects/MessageWindow":38,"../../../common/lib/ignore":52,"../../../common/utils/eventsMixin":76,"../../../common/utils/translateMixin":80,"extend":104}],84:[function(require,module,exports){
'use strict';
...
},{"../../../../common/defaults/configuration":8,"../../../../common/defaults/parameters":9,"extend":104}],86:[function(require,module,exports){
'use strict';
...
ConfigurationMergeWindow.CATEGORIES_TITLES = {
  ...
  gsc: {
    0: 'sqOptions_import_category_gsc',
    disabled: 'sqOptions_import_gsc_disabled'
  }
};
...
},{"../../../../common/dom/main":23,"../../../../common/effects/MessageWindow":38,"../../../../common/lib/diffObjects":49,"../../../../common/lib/isParameterDeleted":58,"../../../../common/utils/eventsMixin":76,"../../../../common/utils/translateMixin":80,"extend":104}],87:[function(require,module,exports){
'use strict';
...
},{"../../../../common/dom/main":23,"../../../../common/utils/eventsMixin":76,"../../../../common/utils/messengerMixin":78,"extend":104}],90:[function(require,module,exports){
'use strict';
...
},{"../../../../common/dom/main":23,"../../../../common/utils/eventsMixin":76,"../../../../common/utils/messengerMixin":78,"../../../../common/utils/messengerTranslateMixin":79,"extend":104}],91:[function(require,module,exports){
'use strict';
...
var GSCPanel = function (_BasePanel) {
  _inherits(GSCPanel, _BasePanel);

  function GSCPanel(container) {
    _classCallCheck(this, GSCPanel);

    return _possibleConstructorReturn(this, (GSCPanel.__proto__ || Object.getPrototypeOf(GSCPanel)).call(this, container));
  }

  _createClass(GSCPanel, [{
    key: 'T',
    value: function T(message) {
      return this.t('sqOptions_gsc_' + message);
    }
  }, {
    key: 'init',
    value: function init() {
      _get(GSCPanel.prototype.__proto__ || Object.getPrototypeOf(GSCPanel.prototype), 'init', this).call(this);
    ...
    value: function translate() {
      ...
      dom.text(this.findChildByRole('title-general'), this.T('title_general'));
      dom.text(this.findChildByRole('gsc-disabled-title'), this.T('disabled_title'));
      dom.text(this.findChildByRole('gsc-disabled-label'), this.T('disabled_label'));
      dom.text(this.findChildByRole('features-title'), this.T('features_title'));
      dom.text(this.findChildByRole('feature-dsts'), this.T('feature_dsts'));
      dom.text(this.findChildByRole('feature-notes'), this.T('feature_notes'));
    }
  }, {
    key: 'setElements',
    value: function setElements() {
      ...
      this.els.clear();
      this.els.set('gsc.disabled', this.findChildById('gsc-disabled'));
      this.els.set('gsc.dsts', this.findChildById('dsts-disabled'));
      this.els.set('gsc.notes', this.findChildById('notes-disabled'));
    ...
    set: function set(value) {
      ...
      _set(GSCPanel.prototype.__proto__ || Object.getPrototypeOf(GSCPanel.prototype), 'element', value, this);
      this.els.forEach(function (element) {
    ...
    get: function get() {
      return _get(GSCPanel.prototype.__proto__ || Object.getPrototypeOf(GSCPanel.prototype), 'element', this);
    }
  }, {
    key: 'configuration',
    set: function set(value) {
      this._changed = false;
      this.els.get('gsc.disabled').checked = value.gsc.disabled === false;
      this.els.get('gsc.dsts').checked = value.gsc.dsts === true;
      this.els.get('gsc.notes').checked = value.gsc.notes === true;
    },
    get: function get() {
      var result = {};
      result.gsc = {
        disabled: !this.els.get('gsc.disabled').checked,
        dsts: this.els.get('gsc.dsts').checked,
        notes: this.els.get('gsc.notes').checked
      };
...
module.exports = GSCPanel;

},{"../../../../common/dom/main":23,"./BasePanel":90}],92:[function(require,module,exports){
'use strict';
...
},{"../../../../common/dom/main":23,"../../../../common/lib/ignore":52,"../../../../common/utils/delay":74,"../../../panel/src/tips/TipsPanel":97,"../import/ConfigurationMergeResult":85,"../import/ConfigurationMergeWindow":86,"./BasePanel":90,"sanitize-filename":109}],93:[function(require,module,exports){
'use strict';
...
},{"../../../../common/dom/main":23,"../../../../common/effects/MessageWindow":38,"../../../../common/lib/isEmpty":55,"../../../../common/semrush/ApiError":70,"../../../../common/semrush/ApiErrorTimeout":71,"../../../../common/utils/messengerMixin":78,"../integration/SemrushIntegration":88,"./BasePanel":90}],94:[function(require,module,exports){
'use strict';
...
},{"../../../../common/dom/main":23,"../../../../common/lib/ignore":52,"../../../../common/lib/shortHash":62,"../../../../common/parameters/ParametersTable":69,"../ParameterForm":83,"../ParametersRestoreMenu":84,"./BasePanel":90}],95:[function(require,module,exports){
'use strict';
...
},{"../../../../common/Lib":5,"../../../../common/dom/main":23,"../../../../common/lib/ignore":52,"../../../../common/parameters/ParametersCheckboxes":67,"./BasePanel":90}],96:[function(require,module,exports){
'use strict';
...
},{"../../../../common/Lib":5,"../../../../common/dom/main":23,"../../../../common/effects/TabsSwitch":41,"../../../../common/lib/ignore":52,"../../../../common/parameters/ParametersCheckboxes":67,"../import/HighlightList":87,"./BasePanel":90,"extend":104}],97:[function(require,module,exports){
'use strict';
...
},{"../../../../common/dom/main":23,"../../../../common/effects/FxLeft":35,"../../../../common/lib/ignore":52,"../../../../common/utils/eventsMixin":76,"../../../../common/utils/translateMixin":80}],98:[function(require,module,exports){
'use strict';
...
},{"browser/Client":1,"modules/options/src/OptionsBase":81}],99:[function(require,module,exports){
var toCamelCase = require('to-camel-case');
...
},{"to-camel-case":100}],100:[function(require,module,exports){
...
},{"to-space-case":114}],101:[function(require,module,exports){
/**
...
},{"dom-element-css":99,"dom-element-value":101,"to-camel-case":103}],103:[function(require,module,exports){
arguments[4][100][0].apply(exports,arguments)
},{"dup":100,"to-space-case":114}],104:[function(require,module,exports){
'use strict';
...
},{"./lib/html4-entities.js":106,"./lib/html5-entities.js":107,"./lib/xml-entities.js":108}],106:[function(require,module,exports){
...
},{"truncate-utf8-bytes":115}],110:[function(require,module,exports){
...
},{"to-no-case":113}],115:[function(require,module,exports){
'use strict';
...
},{"./lib/truncate":116,"utf8-byte-length/browser":117}],116:[function(require,module,exports){
'use strict';
